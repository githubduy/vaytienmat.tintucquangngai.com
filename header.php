...
// Lấy trang hiện tại từ tham số GET (do .htaccess rewrite) hoặc mặc định là index
...
<body>
    <header>
        ...
        <nav class="navbar">
            <div class="container">
                <a href="/" class="logo"><i class="fas fa-hand-holding-usd"></i> <?php echo $contactConfig['brand']; ?></a>
                ...
                <ul class="nav-links">
                    <li><a href="/" class="<?php echo ($currentPage == 'index') ? 'active' : ''; ?>"><i class="fas fa-home"></i> Trang chủ</a></li>
                    <li class="dropdown">
                    ...
                    <li class="dropdown">
                        ...
                        <div class="dropdown-content">
                            <a href="dich-vu/gioi-thieu-app-banking"><i class="fas fa-mobile-alt"></i> Hướng dẫn vay qua App SHB</a>
                            <a href="dich-vu/tat-toan-khoan-vay"><i class="fas fa-check-double"></i> Hướng dẫn tất toán</a>
                            <a href="dich-vu/no-qua-han"><i class="fas fa-exclamation-triangle"></i> Tìm hiểu nợ quá hạn</a>
